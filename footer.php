	...
	<footer>
		<div id="footer-bg">
			<div id="footer" class="container">
				...
				<p class="contact-info"><a href="mailto:connect@be-movement.com">connect@be-movement.com</a> <br> be movement<br/>The Hub / NYC Academy <br/>113 Somerset Road Singapore 238165.</p>
			</div><!-- /Footer -->
		</div><!-- /Footer-bg -->
	</footer><!-- /Footer -->
